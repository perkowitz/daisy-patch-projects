...
float Tom8::presets[][Tom8::PARAM_COUNT] = {
    ...
    {80, 80, 0.886, 1.0, 0.5, 0.05, 0.05},
    {171, 171, 0.682, 0.5, 1, 0.05, 0.05, 0.05},
    {94, 94, 0.823, 1, 5, 0.05, 0.05, 0.05},
    {59, 120, 0.882, 0.46, 0.1, 0.05, 0.05, 0.05},
...
float Tom8::mtPresets[][Tom8::PARAM_COUNT] = {
    ...
    {210, 214, 0.987, 1, 0, 0.05, 0.05, 0.05},
...
float Tom8::htPresets[][Tom8::PARAM_COUNT] = {
    // freq, freq1, decay, osc2 level, ringmod level, squeeze, reverb, bend
    {131, 137, 0.940, 1.0, 0.2, 0.05, 0.05, 0.05},
