...
#define MOMO_MAX_KLOK 3
#define MOMO_KLOK_COUNT_LIMIT 8
#define MOMO_MAX_DRIFT_RATE 32

class Momo: public ISynth {
    ...
    public:
        ...
        static const u8 PARAM_F_DRIFT = 26;
        static const u8 PARAM_FRES_DRIFT = 27;
        static const u8 PARAM_DRIFT_RATE = 28;
        static const u8 PARAM_DRIFT_LOOP = 29;
        static const u8 PARAM_MIDI_CHANNEL = 30;
        ...
        std::string Name() { return "Momo"; }
        std::string ShortName() { return "Mo"; }
